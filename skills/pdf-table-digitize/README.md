...
Типичный пример: оцифровка `нагрузка.pdf` (отсканированный документ, несколько страниц с разной ориентацией):

1. Страница 1 — аудиторная нагрузка Иванова И.И. (двухуровневая шапка)
2. Страница 2 — практики Иванова И.И.
